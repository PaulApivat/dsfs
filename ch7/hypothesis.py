...
# In particular, let's say we flip a coin n = 1000 times, if the 'fairness' hypothesis is true, X should be distributed approximately normal with mean 500 and standard deviation 15.8
